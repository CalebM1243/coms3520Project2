...
- **Thread 1 — Journal Metadata Stage**  
  - Responsibilities  
  - How it interacts with buffers  

- **Thread 2 — Commit Stage (TXE)**  
  - Responsibilities  

- **Thread 3 — Checkpoint Stage**  
  - Responsibilities  
...
The whole buffer data structure is designed to be thread safe since we lock and unlock the mutex as well as use the conditional variables to wake up or put the threads to sleep until they are needed. There are no spin locks. 
